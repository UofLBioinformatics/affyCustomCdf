/**
 * Files was taken from affxparser R Bioconducter package
 * which also uses the Affymetrix created fusion_sdk library.
 * File is required in order to compile fusion_sdk
